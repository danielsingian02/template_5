...
function styles() {
	...
	wp_enqueue_style( 'bootsrap5', 'https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css', array(), '5.2.2', 'all' );	
...
function scripts() {
	...
	wp_enqueue_script( 'bootsrap4', 'https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js', array(), '5.2.2', true );
		
	//wp_enqueue_script( 'hamburger-script', get_template_directory_uri() . '/inc/hamburger/hamburger.js', array( 'jquery' ), '1.0.0', true );
